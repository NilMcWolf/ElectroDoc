...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            replaceText(document, "ФИО", "Ткачук Даниил Никитович");                                                   // Ф
            replaceText(document, "ДействующаяДействующий", "действующий");                                              // действующая | действующий
            replaceText(document, "НомерПаспорта", "05 03 № 952371");                                                        // серия паспорта
            replaceText(document, "КемВыдан", "Питерской Сукой Приморского края от 23.07.2004г");
            ...
            replaceText(document, "НомерСчетчика", "СукаГовноНомерПидор111");                                          // 021В267708178
            replaceText(document, "ИменуемаяИменуемый", "именуемый");                                                 //именуемая | именуемый
            replaceText(document, "Улица", "Карьерная");                                                       // Улица
            replaceText(document, "НомерДома", "2");                                                               // Номер дома
